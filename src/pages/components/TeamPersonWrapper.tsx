...
function TeamPersonWrapper({  name, position, email,emailLink, linkedInName, linkedInLink, svg, mobileNumber } : TeamMember) {
  ...
  return (
    <div style={teamPersonElementStyle}>
        ...
        <div style={teamPersonInformationOuterWrapperStyle}>
              ...
              <div style={{...teamPersonAdditionInfoOuterWrapperStyle, justifyContent: 'flex-start'}}>
                  <img src={EmailSvg} style={teamPersonIconsWrapperStyle} alt="email"/>
                  <LinkedInIcon>
                    <img src={email} alt="email" onClick={()=>handleEmailClick(emailLink)} />
                  </LinkedInIcon>
              </div>
              <div style={{...teamPersonAdditionInfoOuterWrapperStyle, justifyContent: 'flex-start'}}
              ref={containerRef}
              ...
              >
                  <img src={LinkedInSvg} style={teamPersonIconsWrapperStyle}  alt="linkedIn"/>
                    <LinkedInIcon>
                    <img src={linkedInName} alt='linkedIn'/>
                    </LinkedInIcon>
              </div>
              <div style={{...teamPersonAdditionInfoOuterWrapperStyle, justifyContent: 'flex-start'}}>
                 <img src={TelephonSvg} style={teamPersonIconsWrapperStyle} alt="phone"/>
